...
if (string.IsNullOrEmpty(userName) || userName.Any(char.IsDigit))
{
    Console.WriteLine("Error: Bhai jaan, naam me numbers ya digits nahi aate, aur na hi naam khali ho sakta hai!");
