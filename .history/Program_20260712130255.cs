...
if (isFirstValid && isSecondValid)
{
    ...
    Console.WriteLine($"Apke diye hue digits ka total sum hai: {result}");
}
else
{
    // Agar kisi aik me bhi text hua, toh crash nahi hoga, balkay yeh message aayega
    Console.WriteLine($"{userName} ap na inputs me number ki jagah kuch or enter kiya ha ... Sahi digits enter karein!");
}